...
export default class ZIM {
    ...
    replyMessage(message: ZIMMessage, toOriginMessage: ZIMMessage, config: ZIMMessageSendConfig, notification?: ZIMMessageSendNotification): Promise<ZIMMessageSentResult>;
