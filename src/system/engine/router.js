	...
	},
	{
        ...
        children: [{
			...
			children: [{
				...
				path: '/app/tools/householding',
				meta: {title:'menu.app_tools_householding',icon:'flag',permission: 'DSC81L', parents:'app'},
				component: () => import('@/views/app/tools/householding.vue'),
			},{
