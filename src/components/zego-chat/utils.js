...
export const appConfig = {
    // liveside
    appID: 562760322, 
    serverSecret: '1acb4006b394d1e9898de117251088d7', 
};

export function generateSignature(){
    var appID = '562760322'
    var serverSecret = '1acb4006b394d1e9898de117251088d7'
    var timestamp = Date.now() / 1000 | 0
    var signatureNonce = (Math.random() * 2147483647) | 0
    var signature = appID+signatureNonce.toString()+serverSecret+timestamp.toString()
    signature = CryptoJS.MD5(signature).toString()

    var result = 'AppId='+appID+'&SignatureNonce='+signatureNonce+'&Timestamp='+timestamp+'&Signature='+signature+'&SignatureVersion=2.0'
...
export function callUserTagType(state,caller){
